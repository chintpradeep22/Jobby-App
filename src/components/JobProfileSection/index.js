...
class JobProfileSection extends Component {
    ...
    changeEmploymentType = selectedType => {
        this.setState(prevState => {
            ...
            if (employmentType.includes(selectedType)) {
                // If selectedType exists, remove it from the array
                updatedEmploymentTypes = employmentType.filter(
                    type => type !== selectedType,
                )
            } else {
                // If not exists, add it to the array
                updatedEmploymentTypes = [...employmentType, selectedType]
            }

            return { employmentType: updatedEmploymentTypes }
        }, this.getJobDetails) // fetch updated job list after state update
    }
    ...
    renderLoadingView = () => (
        <div className="profile-loader-container" data-testids="loader">
